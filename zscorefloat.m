function [z,mu,sigma] = zscorefloat(x,flag,dim)
%ZSCORE Standardized z score with floating-point arithmetic (20120816 JW).
...
sigma0 = sigma;
sigma0(abs(sigma0)<1e-14) = 1;
% sigma0(sigma0==0) = 1;  % old version
z = bsxfun(@minus,x, mu);
z(abs(z)<1e-14) = 0;    % added this
